						...
						<form action="" method="post" enctype="multipart/form-data">
								...
								<table align="center" width="750px">
									...
									<tr>
										...
										<td><input type="file" name="c_image"/><img src="customer_images/<?php echo $image; ?>" width="100px" height="100px"/></td>
									</tr>
									...
									<tr align="center">
										...
										<td colspan="6"><input type="submit" name="update" value="Update Acccount"/></td>
									</tr>
